...
class CNN(nn.Module):
    ...
    def __init__(self, input_dimension):
        ...
        self.fc1 = nn.Linear(3456, 576)
        self.fc2 = nn.Linear(576, 96)
        self.fc3_1 = nn.Linear(96, 10)
        self.fc3_2 = nn.Linear(96, 10)
    ...
    def forward(self, x):
        ...
        first = self.relu(self.fc3_1(out))
        second = self.relu(self.fc3_2(out))
